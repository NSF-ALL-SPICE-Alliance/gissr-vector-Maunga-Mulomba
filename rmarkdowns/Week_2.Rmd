...
ggplot(data = world) +
  geom_sf() +
  coord_sf(xlim = c(25, 30), ylim = c(-12, -18.1), expand = FALSE) +
  ggtitle("Southern Region of Zambia")+
  theme_void()
...
ggplot() +
    ...
    geom_sf(data = states, fill = "#F7EBE3", size = 0.25) +
    geom_sf(data = lakes50, fill = "darkblue", color = "black") +
    geom_sf(data = rivers50, color = "#078EA3", linewidth = 1.05) +
...
ggplot() +
    ...
    geom_sf(data = states, fill = "#FAECD8", linewidth = 0.6) +
    geom_sf(data = lakes50, fill = "#0DC786", color = "#046141") +
    geom_sf(data = rivers50, color = "#0A84BD", linewidth = 1.2) +
    geom_sf(data = southern, fill = "#E8CDA5", color = "#442B06", linewidth = 0.8)+
    geom_text(data = states, aes(x = longitude, y = latitude, label = name), size = 3.6, fontface = "bold", nudge_y = states$nudge_y) +
    coord_sf(xlim = c(25, 30), ylim = c(-12, -18.1), expand = FALSE) +
    ggtitle("Southern Province", subtitle = "in the southern region of Zambia")+
    theme_void()
