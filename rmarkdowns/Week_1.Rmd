...
ggplot(data = world) +
    geom_sf() +
    ggtitle("Countries of the World", subtitle = "Created by Maunga Mulomba")
...
ggplot() + 
  geom_sf(data = world_without_antarctica, 
          fill="#98FF98", color="#008080", scale = 0.2) +
  ggtitle("Countries of the World", subtitle = "without Antarctica")
```
...
```{r}
ggplot(data = world_without_antarctica) +
  geom_sf(aes(fill = as.factor(mapcolor7)), color = "#000", size = 0.3) +
...
ggplot(data = world) +
  ...
  coord_sf(crs = "+proj=ortho +lat_0=-17 +lon_0=25") +
  ggtitle("Livingstone, ZM as the Center of the World", subtitle = "Orthographic Azimuthal")
